...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <form class="bg-white shadow-md rounded-lg p-8 w-full max-w-lg space-y-6" action="{{route('mail')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <!-- Attachment Input -->
        <div>
            <label class="block text-sm font-medium text-gray-700" for="message">Attachment</label>
            <input
                type="file"
                name="attachment"
                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
